...
gui_pref_cb(GtkWidget *wid, gui_t *gui) {
    ...
    frame = gtk_frame_new("");
    gtk_box_pack_start(GTK_BOX (gtk_dialog_get_content_area(GTK_DIALOG(dialog))), frame, TRUE, TRUE, 20);
...
gui_delete_dialog_ask(gui_t *gui, const gchar *filename, gint *pflags) {
    ...
    gtk_box_pack_start(GTK_BOX(gtk_dialog_get_content_area(GTK_DIALOG(dia))), all, TRUE, TRUE, 2);
    ...
    gtk_box_pack_start (GTK_BOX (gtk_dialog_get_content_area(GTK_DIALOG (dia))), totrash, TRUE, TRUE, 2);
